...
const TabBlogPane4 = ({ style }: { style?: React.CSSProperties }) => {
  return (
    <div className="tab-pane fade" id="tab-contact4" role="tabpanel" aria-labelledby="tab-contact4-tab" style={style}>
      <div className="all-boxs">
        <Row>
          {blogData4.map((item, index) => (
            <Col lg={6} key={index}>
