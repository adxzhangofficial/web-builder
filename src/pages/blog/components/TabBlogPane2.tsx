...
const TabBlogPane2 = ({ style }: { style?: React.CSSProperties }) => {
  return (
    <div className="tab-pane fade" id="tab-contact2" role="tabpanel" aria-labelledby="tab-contact2-tab" style={style}>
