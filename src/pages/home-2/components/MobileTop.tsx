import HeaderLogo from '@/assets/img/logo/footer-logo5.png'
...
import { FaArrowRight, FaBarsStaggered, FaInstagram, FaLinkedinIn, FaRegEnvelope, FaXmark, FaXTwitter, FaYoutube } from 'react-icons/fa6'
...
const MobileTop = () => {
  ...
  return (
    <div>
      <div className="mobile-header mobile-header3 d-block d-lg-none ">
        <Container fluid>
          <Col xs={12}>
      ...
      <div ref={sidebarRef} className={`mobile-sidebar mobile-sidebar4  d-block d-lg-none ${isOpen ? 'mobile-menu-active' : ''}`}>
        ...
        <div className="mobile-nav">
          <MobileMenu />
          <Link className="sidebar1-btn" to="/contact">
